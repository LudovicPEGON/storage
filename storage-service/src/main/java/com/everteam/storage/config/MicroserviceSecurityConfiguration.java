...
import com.everteam.storage.security.AuthoritiesConstants;
...
public class MicroserviceSecurityConfiguration
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().headers().frameOptions().disable().and()
                ...
                .authorizeRequests().antMatchers("/api/profile-info")
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter(
        ...
        converter.setVerifierKey(
                getKeyFromAuthorizationServer(keyUriRestTemplate));
        return converter;
    }
    ...
    private String getKeyFromAuthorizationServer(
        ...
        return (String) keyUriRestTemplate
                .exchange("http://uaa/oauth/token_key", HttpMethod.GET, request,
                        Map.class)
                .getBody().get("value");
