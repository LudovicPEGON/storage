...
import com.everteam.storage.config.ApplicationProperties;
import com.everteam.storage.config.DefaultProfileUtil;
...
public class StorageApp {
    ...
    public void initApplication() {
        ...
        if (activeProfiles
                .contains(JHipsterConstants.SPRING_PROFILE_DEVELOPMENT)
