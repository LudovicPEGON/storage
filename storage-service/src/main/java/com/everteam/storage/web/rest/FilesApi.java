...
public interface FilesApi {
    ...
    @ApiOperation(value = "Search updated files.", notes = "Launch a batch which is going to search files which have been updated after a specified date. ", response = Void.class, tags = {
            "Files", })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "successfully started", response = Void.class) })
    @RequestMapping(value = "/files/{id}/checkUpdates", produces = {
            "application/json" }, method = RequestMethod.POST)
    default ResponseEntity<Void> checkUpdates(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
    ...
    @ApiOperation(value = "Create a copy", notes = "Copy a file of the specified file", response = ESFile.class, tags = {
            "Files", })
    @ApiResponses(value = {
    ...
    default ResponseEntity<ESFile> copyFile(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
    ...
    @ApiOperation(value = "Insert a new File", notes = "Create a new File using file content and required parameters", response = ESFile.class, tags = {
            "Files", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/files/{id}", produces = {
            "application/json" }, consumes = {
                    "multipart/form-data" }, method = RequestMethod.POST)
    default ResponseEntity<ESFile> createFile(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
    ...
    @ApiOperation(value = "Delete a File", notes = "Delete a File or a directory using its id", response = Void.class, tags = {
            "Files", })
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "Get file informations", notes = "Get file informations", response = ESFile.class, tags = {
            "Files", })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "search results", response = ESFile.class) })
    @RequestMapping(value = "/files/{id}", produces = {
            "application/json" }, method = RequestMethod.GET)
    default ResponseEntity<ESFile> getFile(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
    ...
    @ApiOperation(value = "Get the file children", notes = "Get the specified file's direct children", response = ESFileList.class, tags = {
            "Files", })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "search results matching criteria", response = ESFileList.class) })
    @RequestMapping(value = "/files/{id}/children", produces = {
            "application/json" }, method = RequestMethod.GET)
    default ResponseEntity<ESFileList> getFileChildren(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
            @ApiParam(value = "set true if you want to get permissions at the same time you get files", defaultValue = "false") @RequestParam(value = "getPermissions", required = false, defaultValue = "false") Boolean getPermissions,
            @ApiParam(value = "set true if you want to get checksum at the same time you get files", defaultValue = "false") @RequestParam(value = "getChecksum", required = false, defaultValue = "false") Boolean getChecksum,
    ...
    @ApiOperation(value = "Get the content file", notes = "Get the specified file's content", response = byte[].class, tags = {
            "Files", })
    @ApiResponses(value = {
    ...
    default ResponseEntity<byte[]> getFileContent(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id) {
        // do some magic!
        return new ResponseEntity<byte[]>(HttpStatus.OK);
    }

    @ApiOperation(value = "Get File's Permsissions", notes = "Lists a file's permissions", response = ESPermission.class, responseContainer = "List", tags = {
            "Files", })
    @ApiResponses(value = {
    ...
    default ResponseEntity<List<ESPermission>> getFilePermissions(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id) {
        // do some magic!
        return new ResponseEntity<List<ESPermission>>(HttpStatus.OK);
    }

    @ApiOperation(value = "Move a file", notes = "Move a file to a specified parent", response = ESFile.class, tags = {
            "Files", })
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Successfully moved", response = ESFile.class) })
    @RequestMapping(value = "/files/{id}/move", produces = {
            "application/json" }, method = RequestMethod.POST)
    default ResponseEntity<ESFile> moveFile(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
            @ApiParam(value = "Target file's ID", required = true) @RequestParam(value = "targetId", required = true) String targetId) {
        // do some magic!
        return new ResponseEntity<ESFile>(HttpStatus.OK);
    ...
    @ApiOperation(value = "Updates a file", notes = "Updates a specified file metadata and/or content", response = ESFile.class, tags = {
            "Files", })
    @ApiResponses(value = {
    ...
    default ResponseEntity<ESFile> updateFile(
            @ApiParam(value = "The file's ID", required = true) @PathVariable("id") String id,
            @ApiParam(value = "file detail") @RequestPart("file") MultipartFile content,
            @ApiParam(value = "") @RequestParam(value = "description", required = false) String description) {
        // do some magic!
