...
public class ESPermission {
    ...
    /**
     * The id (can be its email or user code) of the user or group this
    ...
    /**
     * The domain name of the entity this permission refers to. It is present
     * when the permission type is user, group or domain
     * 
     * @return domain
     **/
    ...
    public String toString() {
        ...
        sb.append("    accountType: ").append(toIndentedString(accountType))
                .append("\n");
