...
public class ESFile {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, esFile.id)
                ...
                && Objects.equals(this.lastModifiedTime,
                        esFile.lastModifiedTime)
                && Objects.equals(this.lastAccessTime, esFile.lastAccessTime)
                && Objects.equals(this.lastModifiedUser,
                        esFile.lastModifiedUser)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, repositoryId, parents, name, fileSize,
                directory, description, mimeType, creationTime,
                lastModifiedTime, lastAccessTime, lastModifiedUser, owners,
    ...
    public String toString() {
        ...
        sb.append("    repositoryId: ").append(toIndentedString(repositoryId))
                .append("\n");
        sb.append("    parents: ").append(toIndentedString(parents))
                .append("\n");
        sb.append("    name: ").append(toIndentedString(name)).append("\n");
        sb.append("    fileSize: ").append(toIndentedString(fileSize))
                .append("\n");
        sb.append("    directory: ").append(toIndentedString(directory))
                .append("\n");
        sb.append("    description: ").append(toIndentedString(description))
                .append("\n");
        sb.append("    mimeType: ").append(toIndentedString(mimeType))
                .append("\n");
        sb.append("    creationTime: ").append(toIndentedString(creationTime))
                .append("\n");
        sb.append("    lastModifiedTime: ")
                .append(toIndentedString(lastModifiedTime)).append("\n");
        sb.append("    lastAccessTime: ")
                .append(toIndentedString(lastAccessTime)).append("\n");
        sb.append("    lastModifiedUser: ")
                .append(toIndentedString(lastModifiedUser)).append("\n");
        sb.append("    owners: ").append(toIndentedString(owners)).append("\n");
        sb.append("    permissions: ").append(toIndentedString(permissions))
                .append("\n");
        sb.append("    checksum: ").append(toIndentedString(checksum))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
