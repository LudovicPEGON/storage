...
public interface IDrive {
    ...
    ESFileList children(String parentId, boolean addPermissions,
            boolean addChecksum, int maxSize) throws IOException;

    void downloadTo(String fileId, OutputStream outputstream)
            throws IOException;
     ...
     * @throws IOException
     */
    String insertFolder(String parentId, String name, String description)
            throws IOException;
    ...
    ESFile getFile(String fileId, boolean addPermissions, boolean addChecksum)
            throws IOException;

    void update(String fileId, FileInfo info) throws IOException;

    /**
     * Get updates in the drive from the given date <b>fromDate</b> <br>
     * If <b>fileId</b> is specified <br>
     * - <i>If it's a folder</i> : get updates for all files and folders in
     * sub-hierarchy <br>
     ...
     * @throws IOException
     */
    Changes getChanges(String fileId, String token, int maxRows) throws IOException;
